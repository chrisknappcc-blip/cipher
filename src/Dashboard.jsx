...
import PipelineReviewView from './PipelineReviewView'
...
export default function Dashboard({ user, theme, toggleTheme, colorTheme, updateColorTheme, fontSize, updateFontSize, getToken, onScopeError, signOut }) {
  ...
  const NAV_ITEMS = [
    ...
    { key:'resources',     label:'Resources', icon:'book',   color:'var(--nav-resources)' },
  ]
  ...
  const NavIcon = ({ name, color, active }) => {
    ...
    if (name === 'pipeline') return <svg {...common}><path d="M4 4h16v4l-6 6v6l-4-2v-4L4 8z"/></svg>
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--bg)', display:'flex', flexDirection:'column' }}>
      ...
      <div style={{ background:'var(--bg-panel)', borderBottom:'1px solid var(--border-strong)', padding:'0 1.5rem', display:'flex', alignItems:'center', height:52, position:'sticky', top:0, zIndex:50 }}>
        ...
        <div style={{ marginLeft:'auto', display:'flex', alignItems:'center', gap:10 }}>
          ...
          <div style={{ position:'relative' }}>
            <button onClick={() => setSettingsOpen(o => !o)}
              style={{ width:32, height:32, borderRadius:'var(--radius)', background:'var(--bg-secondary)', display:'flex', alignItems:'center', justifyContent:'center', border:'1px solid var(--border-strong)', cursor:'pointer' }}>
      ...
      <div style={{ display:'flex', flex:1, minHeight:0 }}>
        <nav style={{ width:80, flexShrink:0, background:'var(--bg-panel)', borderRight:'1px solid var(--border-strong)', display:'flex', flexDirection:'column', alignItems:'center', gap:22, padding:'20px 8px' }}>
          {NAV_ITEMS.map(tab => (
      ...
      <div style={{ flex:1, padding:'1.5rem', maxWidth: activeTab === 'pipeline-review' ? 1600 : 1280, margin:'0 auto', width:'100%' }}>
        ...
        {activeTab === 'pipeline-review' && (
          <PipelineReviewView getToken={getToken} />
        )}
